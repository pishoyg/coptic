...
def parse_html_class_names(
    old_html: string,
    equivalents_obfuscated_html_classes: Dict,
    class_generator: Callable[[Dict], str],
) -> Tuple:
        ...
        for old_class_name in div_of_classes:
            if old_class_name not in equivalents_obfuscated_html_classes:
                equivalents_obfuscated_html_classes[old_class_name] = (
                    class_generator(equivalents_obfuscated_html_classes)
                )
...
def generate_css(css_content: str = "", equivalent_class: Dict = ()) -> str:
    ...
    Args:
        ...
        equivalent_class (Dict, optional): Dictionary of new class names. Defaults to ().
...
def html_classes_obfuscator(
    htmlfiles=(),
    cssfiles=(),
    jsfiles=(),
    class_generator: Callable[[Dict], str] = lambda _: "_" + str(uuid.uuid4()),
):
    """MAIN.
    ...
    for htmlfile in htmlfiles:
        ...
        with open(htmlfile, "r+", encoding="utf-8") as file:
            ...
            # obfuscate_classes_groups :
            # Should be [['test_1', 'test_2'], ['test_3'], ['test_4'],
            # ['test_5', 'test_6']]
    ...
    for jsfile in jsfiles:
        ...
        with open(jsfile, "r+", encoding="utf-8") as file:
            old_js = file.read()
            new_js = generate_js(old_js, equivalents_obfuscated_html_classes)
