...
PATTERNS: list[Pattern] = [
    ...
    Pattern(["crum/*.html"]),
    Pattern(  # Xooxle indexes
        ["crum/crum.json", "crum/kellia.json", "crum/andreas.json"],
    ),
    Pattern(["crum/crum/headwords.json"]),
    Pattern(["crum/crum/*.tsv"]),  # The Crum TSV is generated by `make crum`.
    ...
    Pattern(["bible/bible.json"]),  # Xooxle index
    Pattern(["bible/pisaxo.json"]),  # Bibliography (generated from YAML)
    Pattern(["bible/*.html"]),
    Pattern(  # Epub files are not tracked in Git.
        ["bible/epub/*"],
        required=False,
    ),
