...
argparser.add_argument(
    ...
    type=bool,
    nargs="*",
    # TODO: (267) copticsite and KELLIA don't get updated. Delete the data, or
    # restore the mask so they will get updated.
    # There is currently no active development on either, so the output will
    # remain the same anyway. They won't get "updated"! But it's not clean to
    # retain data that doesn't get regenerated by the pipeline.
