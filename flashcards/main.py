...
argparser.add_argument(
    ...
    default=[
        ...
        "1::01::TXT:: - ",
        "1::01::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::key",
        # 2. The Bible.
        "2::01::TXT::(",
...
argparser.add_argument(
    ...
    default=[
        # 1. The Dictionary.
        "1::1::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::dialect-B",
        # 2. The Bible.
        "2::1::TSV::bible/stshenouda.org/data/output/csv/bible.csv::Bohairic",
        # 3. copticsite.com
        "3::1::TSV::dictionary/copticsite.com/data/output/output.tsv::Coptic Unicode Alphabet",
    ],
...
argparser.add_argument(
    ...
    default=[
        ...
        "1::02::TXT::(",
        "1::02::TXT::<b>",
        "1::02::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::type-parsed",
        "1::02::TXT::</b>",
        "1::02::TXT::)",
        "1::02::TXT::<br>",
        # Meaning.
        "1::03::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::en-parsed-no-greek",
        "1::03::TXT::<br>",
        # Image.
        "1::04::IMG::dictionary/marcion.sourceforge.net/data/output/roots.tsv::key::dictionary/marcion.sourceforge.net/data/img::{key}-*.*::STEM::300",
        # Horizonal line.
        "1::05::TXT::<hr>",
        # Full entry.
        "1::06::TXT::<b>Word:</b>",
        "1::06::TXT::<br>",
        "1::06::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::word-parsed-no-ref",
        "1::06::TXT::<hr>",
        # Full meaning.
        "1::07::TXT::<b>Meaning:</b>",
        "1::07::TXT::<br>",
        "1::07::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::en-parsed",
        "1::07::TXT::<hr>",
        # Crum's entry.
        "1::08::TXT::<b>Crum: </b>",
        "1::08::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::crum",
        "1::08::TXT::<br>",
        "1::08::IMG::dictionary/marcion.sourceforge.net/data/output/roots.tsv::crum-pages::dictionary/marcion.sourceforge.net/data/crum::numexpr({key}+20).png::KEY",
        "1::08::TXT::<hr>",
        # Marcion's key.
        "1::09::TXT::<b>Key: </b>",
        "1::09::TSV::dictionary/marcion.sourceforge.net/data/output/roots.tsv::key",
        # 2. The Bible.
        # Reference.
        "2::02::TXT::(",
        ...
        "3::02::TXT::(",
        "3::02::TXT::<b>",
        "3::02::TSV::dictionary/copticsite.com/data/output/output.tsv::Word Kind",
        "3::02::TXT::</b>",
        "3::02::TXT::)",
        "3::02::TXT::<br>",
        "3::03::TXT::(",
        "3::03::TXT::<b>",
        "3::03::TSV::dictionary/copticsite.com/data/output/output.tsv::Word Gender",
        "3::03::TXT::</b>",
        "3::03::TXT::)",
        "3::03::TXT::<br>",
        "3::04::TXT::(",
        "3::04::TXT::<b>",
        "3::04::TSV::dictionary/copticsite.com/data/output/output.tsv::Origin",
        "3::04::TXT::</b>",
        "3::04::TXT::)",
        "3::04::TXT::<br>",
        "3::05::TSV::dictionary/copticsite.com/data/output/output.tsv::Meaning",
    ],
...
argparser.add_argument(
    ...
    default=[
        ...
        "2::1::TXT:::",
        "2::1::TXT:::",
        "2::1::TSV::bible/stshenouda.org/data/output/csv/bible.csv::testament-indexed",
        "2::1::TXT:::",
        "2::1::TXT:::",
        "2::1::TSV::bible/stshenouda.org/data/output/csv/bible.csv::section-indexed",
        "2::1::TXT:::",
        "2::1::TXT:::",
        "2::1::TSV::bible/stshenouda.org/data/output/csv/bible.csv::book-indexed",
        "2::1::TXT:::",
        "2::1::TXT:::",
        "2::1::TSV::bible/stshenouda.org/data/output/csv/bible.csv::chapter-zfilled",
        # 3. copticsite.com
