' A Microsoft Word macro for converting from one of the well-known Coptic
...
'
' Please see https://support.microsoft.com/en-us/office/create-or-run-a-macro-c6b99036-905c-49a6-818a-dfb98b7c3c9c
...
With Selection
    ...
    Next char
    Selection.Delete
    Selection.InsertAfter Text:=transliteration
End With
