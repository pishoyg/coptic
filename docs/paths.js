 ...
 * @returns
 */
export function crum(key, drvKey) {
 ...
 * @returns
 */
export function dawoudScan(page) {
 ...
 * @returns
 */
export function lexiconLookup(query) {
 ...
 * @returns
 */
export function bible(book, chapter, verse) {
  if (!chapter) {
    // This is a book URL.
 ...
 * @returns
 */
export function copticDictionaryOnline(key) {
 ...
 * @returns
 */
export function nagHammadiPapyrus(codex, leaf) {
  return (
