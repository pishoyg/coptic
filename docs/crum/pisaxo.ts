...
export interface Source {
   ...
   * TODO: (#522) The `title` field should become required once all sources are
   * populated.
   */
...
export const DATA: Source[] = [
  /**
   * Section 1 lists the sources from Crum's list of abbreviations.
   *
   ...
   *
   * NOTE: Crum often used abbreviated form inconsistently, which complicates
   * our parsing. In cases where there is inconsistency with spacing, the stored
   ...
   * preemptively inserting spaces wherever they may be expected to show, even
   * if we haven't encountered such space variants in the text.
   */
  {
  ...
  {
    title:
      '<em>continuation of</em> <em>H. Almkvist, Kleine Beitr. z. Lexikographie d. vulg. Arabischen, 8th Or. Congr., 1891</em>; ed. K. V. Zetterstéen, in Le Monde Oriental, 1925',
    description: [
  ...
  /*
   * Section 2 stores references not mentioned by crum in the list of
   * abbreviations, but encountered throughout the text.
