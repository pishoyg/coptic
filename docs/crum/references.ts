...
export const MAPPING: Record<string, Source> = {
  ...
  Abst: {
    ...
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Bishop Ṣamūʾīl, Father Fīlūṯāʾūs al-Maqārī, Cantor Mīḫāʾīl Girgis al-Batanūnī. (1913). <em><a href="https://digitale-sammlungen.ulb.uni-bonn.de/content/titleinfo/3336324" rel="noreferrer noopener" target="_blank">al-Ibṣāliyyāt wa-al-Ṭurūḥāt al-Wāṭis wa-al-Ādām</a></em> [الإبصاليات والطروحات الواطس والآدام]. Old Cairo.</li></ul>',
  },
  Aeg: {
    title: 'Lagarde, Aegyptiaca, 1883',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Lagarde, P. de. (1883). <em><a href="https://archive.org/details/aegyptiaca01lagagoog/page/n4/mode/2up" rel="noreferrer noopener" target="_blank">Aegyptiaca Pauli de Lagarde studio et sumptibus edita</a></em>. Gottingae: In aedibus Dieterichianis Arnoldi Hoyer.</li></ul>',
  },
  Aegyptus: {
    title: '(periodical), Milan, acc. to vols',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size"> <em>Aegyptus</em> journal is available digitised from 1920 to recent years on <a href="https://www.jstor.org/journal/aegy" rel="noreferrer noopener" target="_blank">JSTOR</a>. </li></ul>',
  },
  AIssa: {
    title: 'Ahmed Issa, Dict. des Noms des Plantes, Cairo, 1930',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Issa, A. B. (1930). <em><a href="https://digitalcollections.aucegypt.edu/digital/collection/p15795coll33/id/321/rec/5" rel="noreferrer noopener" target="_blank">Dictionnaire des noms des plantes, en latin, français, anglais et arabe</a></em>. Le Caire: Imprimerie nationale.</li></ul>',
  },
  AJSL: {
    title: 'American Journ. of Semit. Languages',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">The <em>American Journal of Semitic Languages and Literatures</em> is available digitised from 1895-1941 (vols. 12-58) on <a href="https://www.jstor.org/journal/amerjsemilanglit" rel="noreferrer noopener" target="_blank">JSTOR</a>. [From 1884-1895 (vols. 1-11) the journal was called <em>Hebraica</em> and from 1942 it became the <em>Journal of Near Eastern Studies</em> (vol. 59 onward).] </li></ul>',
  },
  ...
  'Almk 2': {
    ...
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size"><em><a href="https://www.google.co.uk/books/edition/Le_Monde_oriental/r9IbAAAAMAAJ?hl=en&amp;gbpv=1&amp;pg=PA293&amp;printsec=frontcover" rel="noreferrer noopener" target="_blank">Le Monde Oriental</a></em>. (1925). Vol. XIX. Uppsala.</li></ul>',
  },
  ALR: {
  ...
  Balestri: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Balestri, I. (Ed.). (1904). <em><a href="https://archive.org/details/sacrorumbiblioru03unse/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Sacrorum Bibliorum Fragmenta Copto-Sahidica Musei Borgiani</a></em>, Vol. III: <em>Novum Testamentum</em>. Rome: Typis S. C. de Propaganda Fide.</li></ul>',
  },
  Baouit: {
    title: 'Le Monastère de B., ed. J. Clédat, I & II (= MIF. xii), 1904 ff',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Clédat, J. (1904). <em><a href="https://archive.org/details/MIFAO12et13/mode/2up" rel="noreferrer noopener" target="_blank">Le monastère et la nécropole de Baouît</a></em>. (Mémoires publiés par les membres de l’Institut français d’archéologie orientale du Caire, Vol. 12). Le Caire: Imprimerie de l’Institut français d’archéologie orientale.</li></ul>',
  },
  BAp: {
    title: 'Budge, Coptic Apocrypha, 1913',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1913). <em><a href="https://archive.org/details/copticapocryphai00budguoft/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Coptic Apocrypha in the Dialect of Upper Egypt: Edited with English Translations</a></em>. London: British Museum.</li></ul>',
  },
  'Berl Or': {
  ...
  Bess: {
    ...
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size"> <em>Bessarione</em> began in 1896 and continued until 1923. All volumes digitised and available on the Biblioteca Nazionale Centrale di Roma’s <a href="http://digitale.bnc.roma.sbn.it/tecadigitale/emeroteca/classic/TO00178193" rel="noreferrer noopener" target="_blank">Biblioteca Digitale</a>. </li></ul>',
  },
  BG: {
    title:
  ...
  BHom: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1910). <em><a href="https://archive.org/details/coptichomiliesin00budgrich/page/n11/mode/2up" rel="noreferrer noopener" target="_blank">Coptic Homilies in the Dialect of Upper Egypt edited from the Papyrus Codex Oriental 5001 in the British Museum</a></em>. London: British Museum.</li></ul>',
  },
  BIF: {
    title: 'Bulletin de l’lnstit. français… au Caire',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>All volumes of <em>Le Bulletin de l’Institut français d’ archéologie orientale</em> (BIFAO) published from 1901 to date are listed, digitised, and freely available via the <a href="https://www.ifao.egnet.net/bifao/" rel="noreferrer noopener" target="_blank">Institut français d’ archéologie orientale</a>. </li></ul>',
  },
  BKU: {
    title:
      'Berliner Kopt. Urkunden, acc. to vol., no. and, in long texts, lines',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Erman, A. (1904). <em><a href="https://archive.org/details/mdp.39015020865393/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">Aegyptische Urkunden aus den Königlichen Museen zu Berlin: Koptische Urkunden (BKU)</a></em>. Vol. 1. Berlin: Weidmannsche Buchhandlung. [Several of the BKU I texts (along with other collections) have been digitised at the <a href="https://berlpap.smb.museum/bku-i/" rel="noreferrer noopener" target="_blank">Berliner Papyrusdatenbank</a>.] </li></ul>',
  },
  Blake: {
    title:
      'Epiphanius, De XII Gemmis, ed. R. P. Blake, Coptic fragts. by H. De Vis, 1934 (in Lake’s Studies & Documents)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Blake, R. P., &amp; de Vis, H. (Eds.). (1934). <em><a href="https://archive.org/details/MN41447ucmf_1/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Epiphanius de gemmis: The Old Georgian Version and the Fragments of the Armenian Version</a></em> by R. P. Blake, and <em>The Coptic-Sahidic Fragments</em> by H. de Vis. (Studies and Documents, Vol. 2). London: Christophers.</li></ul>',
  },
  BM: {
  ...
  BMar: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1914). <em><a href="https://archive.org/details/CopticMartyrdomshighResByEWallisBudgeVol01/mode/2up" rel="noreferrer noopener" target="_blank">Coptic Martyrdoms, etc., in the Dialect of Upper Egypt</a></em>. London: British Museum.</li></ul>',
  },
  BMEA: {
    title:
  ...
  BMis: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1915). <em><a href="https://archive.org/details/miscellaneouscop00budguoft/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">Miscellaneous Coptic Texts in the Dialect of Upper Egypt edited with English translations</a></em>. London: British Museum.</li></ul>',
  },
  Bodl: {
  ...
  Br: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Schmidt, C. (1892). <em><a href="https://www.google.co.uk/books/edition/Gnostische_Schriften_in_koptischer_Sprac/esVQJzTZIpgC?hl=en&amp;gbpv=1" rel="noreferrer noopener" target="_blank">Gnostische Schriften in koptischer Sprache aus dem Codex Brucianus</a></em>. (Texte und Untersuchungen zur Geschichte der altchristlichen Literatur, Vol. 8). Leipzig: J. C. Hinrichs’sche Buchhandlung.</li></ul>',
  },
  BSG: {
    title: 'Budge, Martyrdom & Miracles of St. George, 1888',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1888). <em><a href="https://archive.org/details/martyrdommiracle00budguoft/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">The Martyrdom and Miracles of Saint George of Cappadocia: The Coptic Texts edited with an English translation</a></em>. London: D. Nutt.</li></ul>',
  },
  BSM: {
    title: 'Budge, St. Michael the Archangel, 1894',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Budge, E. A. W. (1894). <em><a href="https://archive.org/details/StMichael3Encomiums/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Saint Michael the Archangel: Three Encomiums by Theodosius, Archbishop of Alexandria, Severus, Patriarch of Antioch, and Eustathius, Bishop of Trake</a></em>; the Coptic texts with extracts from Arabic and Ethiopic versions, edited with a translation. London: Kegan Paul, Trench, Trübner &amp; Co.</li></ul>',
  },
  C: {
    title:
      'Corpus Scriptorum Christian. Oriental., acc. to the “numéros d’ ordre”',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size"> <strong>T. 41</strong> <em>Sinuthii Vita</em>, ed. J. Leipoldt, 1906. <ul class="wp-block-list"> <li class="has-medium-font-size">Leipoldt, J. (1906). <em><a href="https://archive.org/details/sinuthiiarchiman0000shen_i0u5/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Sinuthii archimandritae Vita et Opera omnia</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 41; Scriptores Coptici, Tom. 1). Paris: Imprimérie nationale. (Reprinted 1951, Louvain: L. Durbecq).</li> </ul> </li></ul><ul class="wp-block-list has-medium-font-size"> <li> <strong>42, 73</strong> <em>Sinuthii Opera</em>, do., 1908, 1913. <ul class="wp-block-list"> <li>Leipoldt, J. (1908). <em><a href="https://archive.org/details/sinuthiiarchiman0000shen_z1m2/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Sinuthii archimandritae Vita et Opera omnia, III</a></em>, with the assistance of W. E. Crum. (Corpus Scriptorum Christianorum Orientalium, Vol. 42; Scriptores Coptici, Tom. 2). Paris: Imprimérie nationale. (Reprinted 1955, Louvain: L. Durbecq).</li> <li class="has-medium-font-size">Leipoldt, J. (1913). <em><a href="https://archive.org/details/sinuthiiarchiman0000shen/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Sinuthii archimandritae Vita et Opera omnia, IV</a></em>, with the assistance of W. E. Crum. (Corpus Scriptorum Christianorum Orientalium, Vol. 73; Scriptores Coptici, Tom. 5). Paris: Imprimérie nationale. (Reprinted 1954, Louvain: L. Durbecq). <br></li> </ul> </li> <li class="has-medium-font-size"> <strong>43, 86</strong> <em>Acta Martyrum</em>, edd. I. Balestri &amp; H. Hyvernat, 1907, 1924. <ul class="wp-block-list"> <li class="has-medium-font-size">Balestri, J. &amp; Hyvernat, H. (1907). <em><a href="https://archive.org/details/actamartyrum0043bale/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Acta martyrum, I</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 43; Scriptores Coptici, Tom. 3). Paris: Imprimérie nationale. (Reprinted 1955, Louvain: L. Durbecq).</li> <li>Balestri, J. &amp; Hyvernat, H. (1924). <em><a href="https://archive.org/details/actamartyrum0086bale/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Acta martyrum, II</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 86; Scriptores Coptici, Tom. 6). Paris: Imprimérie nationale. (Reprinted 1953, Louvain: L. Durbecq).</li> </ul> </li></ul><ul class="wp-block-list has-medium-font-size"> <li> <strong>89, 99, 100</strong> S. <em>Pachomii Vitae</em>, ed. L. Th. Lefort, 1925, 1933. <ul class="wp-block-list"> <li>Lefort, L. Th. (1925). <em><a href="https://archive.org/details/spachomiivitaboh0000unse/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">S. Pachomii vita bohairice scripta</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 89; Scriptores Coptici, Tom. 7). Paris: Imprimérie nationale. (Reprinted 1953, Louvain: L. Durbecq).</li> <li>Lefort, L. Th. (1933-1934). <em><a href="https://archive.org/details/spachomiivitaesa9910unse/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">S. Pachomii Vitae sahidice scriptae, fasc. 1-2</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 99-100; Scriptores Coptici, Tom. 9-10). Paris: Imprimérie nationale. (Reprinted 1952, Louvain: L. Durbecq).</li> </ul> </li></ul>',
  },
  Cai: {
  ...
  El: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Steindorff, G. (1899). <em><a href="https://archive.org/details/bub_gb_Tpbji86R09kC/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Die Apokalypse des Elias, eine unbekannte Apokalypse und Bruchstücke der Sophonias-Apokalypse koptische texte, übersetzung, glossar</a></em>. (Texte und Untersuchungen zur Geschichte der altchristlichen Literatur, Neue Folge, Band 2, Heft 3a). Leipzig: J. C. Hinrichs’sche Buchhandlung.</li></ul>',
  },
  EnPeterson: {
    title:
  ...
  Ep: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Winlock, H. E, &amp; Crum, W. E. (1926). <em><a href="https://archive.org/details/monasteryofepiph01winl/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">The Monastery of Epiphanius at Thebes. Part I: The archaeological material by H. E. Winlock, and the literary material by W. E. Crum</a></em>. New York: The Metropolitan Museum of Art.</li> <li>Crum, W. E., &amp; Evelyn White, H. G. (1926). <em><a href="https://archive.org/details/monasteryofepiph02winl/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">The Monastery of Epiphanius at Thebes. Part II: Coptic ostraca and papyri edited with translations and commentaries by W. E. Crum, and Greek ostraca and papyri edited with translations and commentaries by H. G. Evelyn White</a></em>. New York: The Metropolitan Museum of Art.</li></ul>',
  },
  EtLeem: {
    title: 'Études… dédiées à C. Leemans, 1885',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li><em><a href="https://www.google.co.uk/books/edition/%C3%89tudes_arch%C3%A9ologiques/ByowAAAAYAAJ?hl=en&amp;gbpv=1" rel="noreferrer noopener" target="_blank">Études archéologiques, linguistiques et historiques dédiées à Mr. le Dr. C. Leemans, à l’occasion du cinquantième anniversaire de sa nomination aux fonctions de Directeur du Musée archéologique des Pays-Bas</a></em>. (1885). Leide: E. J. Brill.</li></ul>',
  },
  EW: {
  ...
  GPar: {
    ...
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">S. Gaselee. (1912, 1914). <em><a href="https://catalog.hathitrust.org/Record/001327863" rel="noreferrer noopener" target="_blank">Parerga Coptica: I. De XXIV Senioribus Apocalypticis et Nominibus Eorum. II. De Abraha et Melchisedec. III. Hymnus de Sinuthio</a></em>. Cantabrigiae: Typis Academicis. [via US access only]</li></ul>',
  },
  GriffStu: {
    title: 'Studies Presented to F. Ll. Griffith, 1932',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li><em><a href="https://archive.org/details/studiespresented0000egyp/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Studies Presented to F. Ll. Griffith</a></em>. (1932). London: Egypt Exploration Society.</li></ul>',
  },
  Gu: {
    title:
      'I. Guidi, Frammenti Copti I-VII (from ALR 1887 ff.), acc. to continuous pagination',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Guidi, I. (1887-88). <a href="https://archive.org/details/frammenticopti00guid/page/46/mode/2up" rel="noreferrer noopener" target="_blank">Frammenti Copti (Nota I-VII)</a>. Reprinted from <em>Rendiconti della Reale Accademia dei Lincei. Classe di Scienze morali, storiche e filologiche</em>, Vols. 3(1-2)-4(1). </li></ul>',
  },
  GuDorm: {
    title: 'I. Guidi, Teste… sopra i Sette Dormienti (Mem. Acad. Linc., 1884)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Guidi, I. (1885). <em><a href="https://archive.org/details/testiorientalii01guidgoog/page/n4/mode/2up" rel="noreferrer noopener" target="_blank">Testi orientali inediti sopra i Sette Dormienti di Efeso</a></em>. (Reale Accademia dei Lincei, Memorie della Classe di scienze morali, storiche e filogiche, ser. 3, 12, 1884, 343-445). Roma: Tipografia della R. Accademia dei Lincei.</li></ul>',
  },
  H: {
    title: 'G. Horner’s text of N.T., 1898-1924',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Horner, G. (1898-1905). <em> The Coptic Version of the New Testament in the Northern Dialect, Otherwise Called Memphitic and Bohairic, with Introduction, Critical Apparatus, and Literal English Translation</em> (4 vols.). Oxford: Clarendon Press. <ul class="wp-block-list"> <li> <a href="https://archive.org/details/copticversionofn01horn/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Volume I</a>: The Gospels of S. Matthew and S. Mark, edited from Ms. Huntingdon 17 in the Bodleian Library </li> <li> <a href="https://archive.org/details/copticversionofn02horn/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Volume II</a>: The Gospels of S. Luke and S. John, edited from Ms. Huntingdon 17 in the Bodleian Library </li> <li> <a href="https://archive.org/details/copticversionofn03horn/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Volume III</a>: The Epistles of S. Paul, edited from Ms. Oriental 424 in the British Museum </li> <li> <a href="https://archive.org/details/copticversionofn04horn/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Volume IV</a>: The Catholic Epistles and the Acts of the Apostles, edited from Ms. Oriental 424 in the British Museum; and The Apocalypse, edited from Ms. Curzon 128 in the care of the British Museum </li> </ul> </li></ul><ul class="wp-block-list has-medium-font-size"> <li>Horner, G. (1911-1924). <em>The Coptic Version of the New Testament in the Southern Dialect, Otherwise Called Sahidic and Thebaic, with Critical Apparatus, Literal English Translation, Register of Fragments and Estimate of the Version</em> (7 vols.). Oxford: Clarendon Press. <ul class="wp-block-list"> <li> <a href="https://archive.org/details/copticversionofn01unse/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Volume I</a>: The Gospels of S. Matthew and S. Mark </li> <li> <a href="https://archive.org/details/copticversionofn02unse/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Volume II</a>: The Gospel of S. Luke </li> <li> <a href="https://archive.org/details/copticversionofn03unse/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Volume III</a>: The Gospel of S. John, register of fragments, etc., facsimiles </li> <li> <a href="https://archive.org/details/copticversionofn04hornuoft/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Volume IV</a>: The Epistles of S. Paul </li> <li> <a href="https://archive.org/details/copticversionofn05unse/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Volume V</a>: The Episles of S. Paul (continued), register of fragments, etc. </li> <li> <a href="https://archive.org/details/copticversionofn06hornuoft/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Volume VI</a>: The Acts of the Apostles </li> <li> <a href="https://archive.org/details/copticversionofn07hornuoft/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Volume VII</a>: The Catholic Epistles and the Apocalypse </li> </ul> </li></ul>',
  },
  Hall: {
    title: 'H. R. Hall, Coptic & Greek Texts… Brit. Museum, 1905, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Hall, H. R. (1905). <em><a href="https://archive.org/details/mdp.39015020865567/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">Coptic and Greek Texts of the Christian Period from Ostraka, Stelae, etc. in the British Museum</a></em>. London: British Museum.</li></ul>',
  },
  HCons: {
    title: 'G. Horner, Consecration of Church & Altar, 1902',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Horner, G. (1902). <em><a href="https://archive.org/details/serviceforconsec00hornuoft/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">The Service for the Consecration of a Church and Altar According to the Coptic Rite, Edited with Translations from a Coptic and Arabic Manuscript of A.D. 1307 for the Bishop of Salisbury</a></em>. London: Harrison and Sons.</li></ul>',
  },
  HengB: {
    title:
      'W. Hengstenberg in Beiträge z. Forschung… Heft III, J. Rosenthal, München, 1914',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Hengstenberg, W. (1914). <a href="https://archive.org/details/hvd.32044095331146/page/n131/mode/2up" rel="noreferrer noopener" target="_blank">Koptische Papyri</a>. In <em>Beiträge zur Forschung: Studien und Mitteilungen aus dem Antiquariat Jacques Rosenthal München, Heft III</em> (pp. 92-100, plus plates). München: Verlag von Jacques Rosenthal. </li></ul>',
  },
  HL: {
    title:
      'E. Amélineau, De Historia Lausiaca, 1887; but Hist Laus = E. C. Butler’s edition of Greek text (= Texts & Studies vi)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Amélineau, E. (1887). <em><a href="https://archive.org/details/dehistorialausia00am/page/n1/mode/2up" rel="noreferrer noopener" target="_blank">De Historia Lausiaca: Quænam sit hujus ad monachorum Aegyptiorum historiam scribendam utilitas</a></em>. Paris: E. Leroux.</li> <li>Butler, D. C. (1898). <em><a href="https://archive.org/details/lausiachistoryof01pall/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">The Lausiac History of Palladius. Vol. I: A Critical Discussion Together with Notes on Early Egyptian Monachism</a></em>. (Texts and Studies: Contributions to Biblical and Patristic Literature, Vol. 6, No. 1). Cambridge: University Press.</li> <li>Butler, D. C. (1904). <em><a href="https://archive.org/details/lausiachistoryof02pall/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">The Lausiac History of Palladius. Vol. II: The Greek Text edited with Introduction and Notes</a></em>. (Texts and Studies: Contributions to Biblical and Patristic Literature, Vol. 6, No. 2). Cambridge: University Press.</li></ul>',
  },
  Hor: {
    title:
      'Griffith, The Old Coptic Horoscope, in AZ 38 76 ff., acc. to pp. of publication',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Griffith, F. Ll. (1900). <a href="https://archive.org/details/zeitschriftfr38brug/page/70/mode/2up" rel="noreferrer noopener" target="_blank">The Old Coptic Horoscope of the Stobart Collection</a>. <em>Zeitschrift für ägyptische Sprache und Altertumskunde</em>, 38, 71-93. </li></ul>',
  },
  HSt: {
    title: 'G. Horner, Statutes of the Apostles, 1904; v also Stat',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Horner, G. (1904). <em><a href="https://archive.org/details/statutesapostle00unkngoog/page/n6/mode/2up" rel="noreferrer noopener" target="_blank">The Statutes of the Apostles or Canones Ecclesiastici. Edited with Translation and Collation from Ethiopic and Arabic MSS.; Also a Translation of the Saʿidic and Collation of the Bohairic Versions; and Saʿidic Fragments</a></em>. London: Williams &amp; Norgate.</li></ul>',
  },
  HT: {
    title:
  ...
  lgR: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Rossi, I. (1808). <em><a href="https://archive.org/details/bub_gb_IWhHswE1yv0C/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Etymologiae Aegyptiacae</a></em>. Rome.</li></ul>',
  },
  'Imp Russ Ar S': {
    // NOTE: Listed as 'ImpRussArS'!
    title: 'Imperial Russian Archaeolog. Soc. xviii, 1907 (Turaief)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Turayev, B. A. (1907). <a href="https://archive.org/details/Notes-Imperial-Russian-Archaeological-Society/ZVORAO_18_1908/page/n55/mode/2up" rel="noreferrer noopener" target="_blank">Ахмимскій папирусъ изъ коллекціи Н. П. Лихачева [An Akhmim Papyrus from the Collection of N. P. Likhachov]</a>. <em>Записки Восточного Отдѣления Императорского Русского Археологическаго Общества</em> [Transactions of the Eastern Branch of the Imperial Russian Archaeological Society], 18, 28-30. </li></ul>',
  },
  J: {
    title:
      'Crum & Steindorff, Kopt. Rechtsurkunden… aus Djême, acc. to no. & line',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Crum, W. E., &amp; Steindorff, G. (1912). <em><a href="https://archive.org/details/koptischerechtsu00crum/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Koptische Rechtsurkunden des achten Jahrhunderts aus Djême (Theben). I. Band: Text und Incides</a></em>. Leipzig: J. C. Hinrichs’sche Buchhandlung.</li></ul>',
  },
  JLeip: {
    // TODO: (#545) Name doesn't make sense when it appears on its own!
    title:
  ...
  JA: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Journal asiatique</em> began in 1822. Volumes are digitised and available on <a href="https://gallica.bnf.fr/ark:/12148/cb34348774p/date" rel="noreferrer noopener" target="_blank">Gallica</a> up to 1940. There are also volumes available on <a href="https://catalog.hathitrust.org/Record/006147183" rel="noreferrer noopener" target="_blank">HathiTrust</a> and listed on <a href="https://www.egyptologyforum.org/EEFDigijournals.html" rel="noreferrer noopener" target="_blank">EgyptologyForum.org</a>. </li></ul>',
  },
  'J & C': {
    // NOTE: Listed as 'J&C'!
    title: 'H. I. Bell, Jews & Christians, 1924, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Bell, H. I. (1924). <em><a href="https://archive.org/details/jewschristiansin0000bell/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">Jews and Christians in Egypt: The Jewish Troubles in Alexandria and the Athanasian Controversy</a></em>. London: British Museum.</li></ul>',
  },
  JAOS: {
    title: 'Journ. of American Orient. Soc',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>The <em>Journal of the American Oriental Society</em> began in 1843-49. All volumes to date are available via <a href="https://www.jstor.org/journal/jameroriesoci" rel="noreferrer noopener" target="_blank">JSTOR</a>. </li></ul>',
  },
  Jern: {
    title:
      'P. Jernstedt, Kopt. Papyri d. Asiat. Mus. (Soc. Egyptol. Univ. Leningrad, no. 6, 1930), acc. to numbers',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Jernstedt, P. (1930). Koptische Papyri des Asiatischen Museums. <em>Сборник египтологического кружка при Ленинградском Государственном Университете</em>, VI, 21–44. [If you know of a digital copy, please <a href="https://www.coptist.com/contact-%e2%b2%a7%e2%b2%81%e2%b2%99%e2%b2%9f%e2%b2%93/"> contact me</a>] </li></ul>',
  },
  JKP: {
    title: 'H. Junker, Koptische Poesie, 1908, 1911 (from Oriens Christianus.)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Junker, H. (1908-1911). <em><a href="https://archive.org/details/koptischepoesied0000junk/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Koptische Poesie des 10. Jahrhunderts</a></em> (2 Bände). Berlin: Karl Curtius. [Reprinted 1977, Hildesheim &amp; New York: Georg Olms Verlag].</li></ul>',
  },
  JSch: {
    title:
      'A. A. Schiller, Ten Coptic Legal Texts, New York, 1932 (includes JLeip, v above), acc. to numbers & lines',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Schiller, A. A. (1932). <em><a href="https://archive.org/details/in.ernet.dli.2015.44575/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Ten Coptic Legal Texts Edited with Translation, Commentary, and Indexes Together with an Introduction</a></em>. New York: Metropolitan Museum of Art.</li></ul>',
  },
  JTS: {
    title: 'Journal of Theological Studies',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>The Journal of Theological Studies</em> began in 1899. Its volumes are available through <a href="https://www.jstor.org/journal/jtheostud" rel="noreferrer noopener" target="_blank">JSTOR</a> with institutional access. Volumes from 1899 to 1929 are hosted on Archive.org and linked on <a href="https://onlinebooks.library.upenn.edu/webbin/serial?id=jtheostudies" rel="noreferrer noopener" target="_blank">The Online Books Page</a>. Others are available through <a href="https://catalog.hathitrust.org/Record/000681411" rel="noreferrer noopener" target="_blank">HathiTrust</a> via US access. </li></ul>',
  },
  K: {
    title:
      'A. Kircher, the Scalæ in Lingua Aegyptiaca Restituta, variants from Loret in Ann. I and other MSS',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Kircher, A. (1644). <em><a href="https://www.google.co.uk/books/edition/Athanasii_Kircheri_Lingua_Aegyptiaca_res/qEtB1x0frAIC?hl=en&amp;gbpv=1" rel="noreferrer noopener" target="_blank">Lingua Aegyptiaca Restituta. Opus Tripartium</a></em>. Rome: Hermann Scheus.</li> <li>Loret, V. (1900). <a href="https://archive.org/details/AnnalesDuServiceDesAntiquitsDeLegyptevolume1/page/n63/mode/2up" rel="noreferrer noopener" target="_blank">Les livres III et IV (animaux et végétaux) de la Scala Magna de Schams-Ar-Riâsah</a>. <em>Annales du Service des antiquités de l’Egypte</em>, 1, 48-63 (edition), 215-229 (indices). </li></ul>',
  },
  Kam: {
    title:
      'Kambysesroman in BKU I, no. 31, acc. to pp. in lower margins & line',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>See <strong><a href="#BKU">BKU</a></strong>.</li></ul>',
  },
  Kandil: {
    title:
      'ⲡϫⲱⲙ ⲛⲧⲉ ⲡⲓⲑⲱϩⲥ ⲉⲑ︦ⲩ︦ (Kitâb al-Masḥah, ay al-Ḳandîl), ed. C. Labîb, Cairo, AM. 1625, v TRit 144 ff',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Labib, C. Y. (1909). <em><a href="https://mc.dlib.nyu.edu/files/books/columbia_aco003890/columbia_aco003890_hi.pdf" rel="noreferrer noopener" target="_blank">Kitāb al-Masḥah, (ʾay al-Qandīl) maʿa Ṣalāt al-Qiddīs ʾAbū Tarbū</a> [كتاب المسحة، (أي القنديل) مع صلاة القديس ابو تربو — ⲡ̀ϫⲱⲙ ⲛ̀ⲧⲉ ⲡⲓⲑⲱϩⲥ ⲉ︦ⲑ︦ⲩ︦ ⲛⲉⲙ ⲡⲓϣ̀ⲗⲏⲗ ⲛ̀ⲧⲉ ⲁⲃⲃⲁ ⲥ̀ⲑⲉⲣⲡⲟⲩ]</em>. Cairo: Heliopolis Press.</li></ul>',
  },
  KKS: {
    title: 'O. von Lemm, Kleine Kopt. Studien, acc. to continuous pagination',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Parts 1-58 published in the <em>Bulletin de l’Académie Impériale des Sciences de St.-Pétersbourg</em>, 1899-1909. Parts I-IX, X-XX, XXI-XXV, XXVI-XLV, XXVI-XLV (Schluss) are available on <a href="https://www.mathnet.ru/php/archive.phtml?wshow=paper&amp;jrnid=im&amp;paperid=4650&amp;option_lang=eng" rel="noreferrer noopener" target="_blank">Mathnet.ru</a>. Part XLVI-L are available on <a href="https://www.orientalstudies.ru/rus/index.php?option=com_publications&amp;Itemid=75&amp;pub=8369" rel="noreferrer noopener" target="_blank">OrientalStudies.ru</a>. Parts LI-LV and LVI-LVIII are outstanding. </li></ul>',
  },
  Kr: {
    title: 'J. Krall, Kopt. Texte (Rainer Corpus II), acc. to numbers',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Krall, J. (1895). <em><a href="https://www.google.co.uk/books/edition/Koptische_Texte_Bd_Rechtsurkunden/VlcPAQAAMAAJ?hl=en&amp;gbpv=1&amp;pg=PR3&amp;printsec=frontcover" rel="noreferrer noopener" target="_blank">Corpus papyrorum Raineri archiducis Austriae. Band II: Koptische Texte</a></em>. Wien: Verlag der Kaiserlich-Königlichen Hof- und Staatsdruckerei.</li></ul>',
  },
  Kropp: {
    title:
  ...
  Lacr: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>La Croze, M. V. (1775). <em><a href="https://www.digitale-sammlungen.de/en/view/bsb10522488?page=6,7" rel="noreferrer noopener" target="_blank">Lexicon Aegyptiaco-Latinum</a></em>. Edited by C. Scholtz and C. G. Woide. Oxford: Clarendon Press.</li></ul>',
  },
  Lag: {
  ...
  LeipBer: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Berichte über die Verhandlungen der Königlich Sächsischen Gesellschaft der Wissenschaften zu Leipzig, Philologisch-Historische Klasse</em> began in 1849. Volumes from 1849-1899 (1-51) available digitised on <a href="https://catalog.hathitrust.org/Record/008559830" rel="noreferrer noopener" target="_blank">HathiTrust</a> with later volumes via US access. </li></ul>',
  },
  Leyd: {
    title: 'Manuscrits coptes du Musée… à Leide, 1897, acc. to pages',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Pleyte, W., &amp; Boeser, P. A. A. (1897). <em><a href="https://archive.org/details/manuscrits-coptes-du-musee-d-antiquite/page/n1/mode/2up" rel="noreferrer noopener" target="_blank">Manuscrits coptes du musée d’antiquités des Pays-Bas à Leide</a></em>. Leide: E. J. Brill.</li></ul>',
  },
  'Leyd AC': {
    title: 'Antiquités Coptes (Catal. du Musée), 1900, acc. to pp',
    // NOTE: Listed as 'LeydAC'!
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Pleyte, W., &amp; Boeser, P. A. A. (1900). <em><a href="https://catalog.hathitrust.org/Record/008693139" rel="noreferrer noopener" target="_blank">Catalogue du musée d’ antiquités à Leide, sousdivision F. Égypte, antiquités coptes</a></em>. Leide: E. J. Brill. [Accessible in the US via HathiTrust.]</li></ul>',
  },
  LIb: {
    title: 'Lemm, Iberica',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Lemm, O. von. (1906). <em><a href="https://www.biodiversitylibrary.org/item/212314#page/653/mode/1up" rel="noreferrer noopener" target="_blank">Iberica</a></em>. (Mémoires de l’Académie impériale des sciences de St.-Pétersbourg, VIIIe série, Tome VII, No. 6). St. Petersburg.</li></ul>',
  },
  LMär: {
    title: 'Lemm, Bruchstücke Kopt. Märtyrerakten',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Lemm, O. von. (1913). <em><a href="https://www.biodiversitylibrary.org/item/212319#page/10/mode/1up" rel="noreferrer noopener" target="_blank">Bruchstücke koptischer Märtyrerakten. I-V.</a></em> (I. Theodoros des Orientalen und Panikyros des Persers und Leontios des Arabers; II. Theodoros des Orientalen; III. Leontios des Arabers; IV. Heraklides; V. Isidoros). (Mémoires de l’ Académie impériale des sciences de St.-Pétersbourg, VIIIe série, Tome XII, No. 1). St. Petersburg.</li></ul>',
  },
  LMis: {
    title: 'Lemm, Koptische Miscellen, acc. to continuous pagination',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Lemm, O. von. (1907-1915). Koptische Miscellen I-CXLVIII published in volumes of the <em>Bulletin de l’Académie Impériale des Sciences de St.-Pétersbourg, VI série</em>. Listed and linked on <a href="https://ancientworldonline.blogspot.com/2012/05/digitized-coptic-publications-of-oscar.html" rel="noreferrer noopener" target="_blank">The Ancient World Online</a>. </li></ul>',
  },
  Löw: {
    title: 'Im. Löw, Aramäische Pflanzennamen, 1881, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Löw, I. (1881). <em><a href="https://archive.org/details/AramaeischePflanzennamen/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Aramæische Pflanzennamen</a></em>. Leipzig: Wilhelm Engelmann.</li></ul>',
  },
  LöwF: {
    title: 'Flora der Juden, 1926 ff',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Löw, I. (1924-1934). <em><a href="https://sammlungen.ub.uni-frankfurt.de/freimann/content/titleinfo/781127" rel="noreferrer noopener" target="_blank">Die Flora der Juden</a></em> (4 Bde.). (Veröffentlichungen der Alexander Kohut Memorial Foundation, Band II-IV, VI). Wien und Leipzig: R. Löwit Verlag.</li></ul>',
  },
  Mallon: {
    title: 'A. Mallon, Grammaire copte², 1907',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Mallon, Al. (1907). <em><a href="https://archive.org/details/grammairecopteav00mall/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Grammaire copte: Avec bibliographie, chrestomathie et vocabulaire</a></em>. Deuxième édition. Beyrouth: Imprimerie Catholique.</li></ul>',
  },
  'Mani 1': {
    title:
  ...
  MIE: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Mémoires présentés à l’Institut Egyptien</em> began in 1862. Volumes as listed, digitised and accessible on the <a href="https://digi.ub.uni-heidelberg.de/diglit/meminstitutegyptien?ui_lang=eng" rel="noreferrer noopener" target="_blank">Heidelberg digital library</a>. </li></ul>',
  },
  MIF: {
    title: 'Mémoires… de l’Instit. franç. d’Archéol. orient. au Caire',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Mémoires publiés par les membres de l’Institut français d’archéologie orientale du Caire</em> (MIFAO) began in 1902. Volumes are listed and linked on <a href="https://www.egyptologyforum.org/EEFSeries.html#9.2" rel="noreferrer noopener" target="_blank">EgyptologyForum.org</a>. </li></ul>',
  },
  Ming: {
    title: 'J. A. Mingarelli, Aegyptiorum Codd. Reliquiae, 1785',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Mingarelli, G. L. (1785). <em><a href="https://archive.org/details/aegyptiorumcodic00ming/page/n3/mode/2up?ref=ol" rel="noreferrer noopener" target="_blank">Aegyptiorum codicum reliquiæ Venetiis in bibliotheca Naniana asservatæ</a></em>. Bononiae: Typis Laelii a Vulpe.</li></ul>',
  },
  Miss: {
    title: 'Mémoires… de la Mission archéol. franç. au Caire',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Mémoires publiés par les membres de la Mission archéologique française au Caire</em> (MMAF) began in 1884. Volumes are listed and linked on <a href="https://www.egyptologyforum.org/EEFSeries.html#9.1" rel="noreferrer noopener" target="_blank">EgyptologyForum.org</a>. </li></ul>',
  },
  MMA: {
  ...
  OLZ: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Orientalistische Litteraturzeitung</em> began in 1898. Links to digitised volumes, especially early volumes, available on <a href="https://onlinebooks.library.upenn.edu/webbin/serial?id=orientliteraturzeitung" rel="noreferrer noopener" target="_blank">The Online Books Page</a>. </li></ul>',
  },
  Ora: {
    title: 'Orientalia (periodical), Rome',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Orientalia</em> began in 1920. All volumes up to recent volumes are available through <a href="https://www.jstor.org/journal/orientalia" rel="noreferrer noopener" target="_blank">JSTOR</a>. </li></ul>',
  },
  'Orat Cyp': {
  ...
  OrChr: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Oriens Christianus</em> began in 1901. All volumes up to 2014 are available digitised on the <a href="https://archive.org/details/oriens-christianus" rel="noreferrer noopener" target="_blank">Internet Archive</a>. </li></ul>',
  },
  Osir: {
    title: 'M.A. Murray, The Osireion, 1904',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Murray, M. A. (1904). <em><a href="https://archive.org/details/osireionatabydos00murr/page/n3/mode/2up" rel="noreferrer noopener" target="_blank">The Osireion at Abydos</a></em>. London: Bernard Quaritch.</li></ul>',
  },
  'Ostr Chicago': {
  ...
  Pcod: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Crum, W. E. (1915). <em><a href="https://archive.org/details/derpapyruscodexs00crum/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Der Papyruscodex saec. VI-VII der Phillippsbibliothek in Cheltenham: Koptische theologische Schriften</a></em>. Strassburg: Karl J. Trübner.</li></ul>',
  },
  PcodF: {
    // TODO: (#545) Name doesn't make sense when it appears on its own!
    title: 'fayyûmic text of same, ed. W. Erichsen (Danish Acad., 1932)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Erichsen, W. (1932). <em><a href="https://archive.org/details/faijumischefragm0000agat/page/n1/mode/2up" rel="noreferrer noopener" target="_blank">Faijumische Fragmente der Reden des Agathonicus Bischofs von Tarsus</a></em>. (Det Kgl. Danske Videnskabernes Selskab, Historisk-filologiske Meddelelser, XIX, 1). København: Andr. Fred. Høst &amp; søn.</li></ul>',
  },
  'Pcod Mor': {
  ...
  Pey: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Peyron, A. (1835). <em><a href="https://archive.org/details/lexiconlinguaeco00peyr/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">Lexicon linguæ Copticæ</a></em>. Taurini: Ex Regio Typographeo.</li></ul>',
  },
  PG: {
    title: 'Migne’s Patrologia, Series Graeca',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Migne, J.-P. (Ed.). (1857-1886). <em>Patrologiae cursus completus, Series Graeca</em> (161 vols.). Paris. All volumes are linked on <a href="https://patristica.net/graeca/" rel="noreferrer noopener" target="_blank">Patristica.net</a> and <a href="https://www.roger-pearse.com/weblog/patrologia-graeca-pg-pdfs/" rel="noreferrer noopener" target="_blank">Roger Pearse’s blog</a>. </li></ul>',
  },
  PGen: {
  ...
  Preisigke: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Preisigke, F. (1922). <em><a href="https://archive.org/details/namenbuch00prei/page/n4/mode/2up" rel="noreferrer noopener" target="_blank">Namenbuch. Enthaltend alle griechischen, lateinischen, ägyptischen, hebräischen, arabischen und sonstigen semitischen und nichtsemitischen Menschennamen, soweit sie in griechischen Urkunden (Papyri, Ostraka, Inschriften, Mumienschildern u.s.w.) Ägyptens sich vorfinden</a></em>. Heidelberg: Selbstverlag des Herausgebers.</li></ul>',
  },
  PS: {
    title: 'Pistis Sophia, ed. C. Schmidt (= Coptica II), 1925',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Schmidt, C. (1925). <em><a href="https://archive.org/details/CarlSchmidtPistisSophia1925Teil1/Carl%20Schmidt%2C%20Pistis%20Sophia%201925%2C%20Teil1/page/n1/mode/2up" rel="noreferrer noopener" target="_blank">Pistis Sophia</a></em>. (Coptica consilio et impensis Instituti Rask-Oerstediani edita, II). Hauniae: Gyldendalske Boghandel-Nordisk Forlag.</li></ul>',
  },
  PSBA: {
    title: 'Proceedings of Soc. of Biblical Archaeology',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Proceedings of the Society of Biblical Archæology</em> began in 1879. The first 30 volumes are linked on <a href="http://archives.getty.edu:30008/getty_images/digitalresources/serials/103990.html" rel="noreferrer noopener" target="_blank">The Getty Research Institute Research Library Catalogue</a>. More volumes available on <a href="https://catalog.hathitrust.org/Record/007887358" rel="noreferrer noopener" target="_blank">HathiTrust</a> via US access. </li></ul>',
  },
  PStras: {
  ...
  RNC: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Rossi, F. (1893). <em><a href="https://www.google.co.uk/books/edition/Un_nuovo_codice_copto_del_Museo_Egizio_d/64GEtkCSqXkC?hl=en&amp;gbpv=1&amp;pg=PA1&amp;printsec=frontcover" rel="noreferrer noopener" target="_blank">Un nuovo codice copto del Museo Egizio di Torino contenente la vita di S. Epifanio ed i martiri di S. Pantaleone, di Ascla, di Apollonio, di Filemone, di Ariano e di Dios con versetti di vari capitoli del “Libro di Giobbe”</a> (Reale Accademia dei Lincei)</em>. Roma: Accademia dei Lincei.</li></ul>',
  },
  ROC: {
    title: 'Revue de l’Orient Chrétien, acc. to vol',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Revue de l’Orient Chrétien</em> began in 1896 and continued until 1935-36 (30 volumes). All the volumes are available via <a href="https://ancientworldonline.blogspot.com/2012/10/opean-access-journal-revue-de-lorient.html" rel="noreferrer noopener" target="_blank">The Ancient World Online</a>. </li></ul>',
  },
  Rösch: {
    title:
      'F. Rösch, Vorbemerkungen zu e. Gramm. d. achmîmischen Mundart, 1909, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Rösch, F. (1909). <em><a href="https://catalog.hathitrust.org/Record/001854607" rel="noreferrer noopener" target="_blank">Vorbemerkungen zu einer Grammatik der achmimischen Mundart</a></em>. Inaugural-Dissertation. Strassburg: Schlesier &amp; Schweikhardt. [Available on HathiTrust via US access.]</li></ul>',
  },
  Ryl: {
    title:
      'Catal. of Coptic MSS. in John Rylands Library, 1909, acc. to numbers',
    innerHTML:
      '<p class="has-medium-font-size"> <strong>RylSuppl</strong> = MSS. acquired since publication of catalogue (<em>cf</em> <a href="https://luna.manchester.ac.uk/luna/servlet/detail/Manchester~25~25~702~196480:New-Coptic-manuscripts-in-the-John-?sort=image_number%2Cimage_sequence_number&amp;qvq=q:escholar005294.pdf;sort:image_number%2Cimage_sequence_number;lc:Manchester~25~25&amp;mi=0&amp;trs=1" rel="noreferrer noopener" target="_blank">Ryl <em>Bull</em>. 5</a>).</p><ul class="wp-block-list has-medium-font-size"> <li>Crum, W. E. (1909). <em><a href="https://archive.org/details/cu31924099175329/page/n11/mode/2up" rel="noreferrer noopener" target="_blank">Catalogue of the Coptic Manuscripts in the Collection of the John Rylands Library, Manchester</a></em>. Manchester: University Press.</li> <li>Crum, W. E. (1918–1920). <a href="https://luna.manchester.ac.uk/luna/servlet/detail/Manchester~25~25~702~196480:New-Coptic-manuscripts-in-the-John-?sort=image_number%2Cimage_sequence_number&amp;qvq=q:escholar005294.pdf;sort:image_number%2Cimage_sequence_number;lc:Manchester~25~25&amp;mi=0&amp;trs=1" rel="noreferrer noopener" target="_blank">New Coptic Manuscripts in the John Rylands Library</a>. <em>Bulletin of the John Rylands Library</em>, 5, pp. 497–503. </li></ul>',
  },
  RylSuppl: {
    // TODO: (#545) Name doesn't make sense when it appears on its own!
    title: 'MSS. acquired since publication of catalogue (cf Ryl Bull. 5)',
    innerHTML:
      '<p class="has-medium-font-size"><strong>Ryl</strong> = <em>Catal. of Coptic MSS. in John Rylands Library</em>, 1909, acc. to numbers; </p><ul class="wp-block-list has-medium-font-size"> <li>Crum, W. E. (1909). <em><a href="https://archive.org/details/cu31924099175329/page/n11/mode/2up" rel="noreferrer noopener" target="_blank">Catalogue of the Coptic Manuscripts in the Collection of the John Rylands Library, Manchester</a></em>. Manchester: University Press.</li> <li>Crum, W. E. (1918–1920). <a href="https://luna.manchester.ac.uk/luna/servlet/detail/Manchester~25~25~702~196480:New-Coptic-manuscripts-in-the-John-?sort=image_number%2Cimage_sequence_number&amp;qvq=q:escholar005294.pdf;sort:image_number%2Cimage_sequence_number;lc:Manchester~25~25&amp;mi=0&amp;trs=1" rel="noreferrer noopener" target="_blank">New Coptic Manuscripts in the John Rylands Library</a>. <em>Bulletin of the John Rylands Library</em>, 5, pp. 497–503. </li></ul>',
  },
  Salîb: {
    title: 'Kitâb aṣ-Ṣalîb, Cairo, 1921',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Father Fīlūṯāʾus al-Maqqārī, Father Barnābā al-Baramūsī, &amp; Father Iqlādiyūs Jirjis. (1921). <em><a href="https://digitale-sammlungen.ulb.uni-bonn.de/content/titleinfo/3198124" rel="noreferrer noopener" target="_blank">Kitāb Dawrat ʿĪday al-Ṣalīb wa-l-Šaʿānīn wa-Ṭarūḥāt al-Ṣawm al-Kabīr wa-l-Ḫamsīn: ḥasaba Tartīb al-Kanīsa al-Qibṭiyyah al-Urṯūḏuksiyyah al-Marqusiyyah</a></em> [كتاب دورة عيدي الصليب والشعانين وطروحات الصوم الكبير والخمسين: حسب ترتيب الكنيسة القبطية الارثوذكسية المرقسية]. Old Cairo: St. Macarius Press.</li></ul>',
  },
  Saq: {
    title:
      'Coptic texts ed. by H. Thompson in Quibell’s Excavations at Saqqara, 1909, 1912',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Quibell, J. E. (1909). <em><a href="https://archive.org/details/cu31924028671265/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Excavations of Saqqara (1907-1908) with Sections by Sir Herbert Thompson and Prof. W. Spiegelberg</a></em>. Le Caire: Imprimerie de l’ Institut français d’archéologie orientale.</li> <li>Quibell, J. E. (1912). <em><a href="https://archive.org/details/cu31924028671273/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Excavations of Saqqara (1908-9, 1909-10): The Monastery of Apa Jeremias (The Coptic Inscriptions edited by Sir Herbert Thompson)</a></em>. Le Caire: Imprimerie de l’Institut français d’archéologie orientale.</li></ul>',
  },
  Sdff: {
    title:
      'G. Steindorff, Koptische Grammatik², acc. to §§, or information from him',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Steindorff, G. (1904). <em><a href="https://archive.org/details/koptischegrammat00stei/page/n9/mode/2up" rel="noreferrer noopener" target="_blank">Koptische Grammatik mit Chrestomathie, Wörterverzeichnis und Literatur. Zweite gänzlich umgearbeitete Auflage</a></em>. Berlin: Reuther &amp; Reichard.</li></ul>',
  },
  Sh: {
    title:
  ...
  Spg: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Spiegelberg, W. (1921). <em><a href="https://archive.org/details/koptischeshandworterbuch/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Koptisches Handwörterbuch</a></em>. Heidelberg: Carl Winters Universitätsbuchhandlung.</li></ul>',
  },
  Sph: {
    title: 'Sphinx (periodical)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Sphinx: revue critique embrassant le domaine entier de l’égyptologie</em> began in 1897 and continued until 1925 (22 volumes). All volumes are listed and available digitised on <a href="https://www.persee.fr/collection/sphin" rel="noreferrer noopener" target="_blank">Persee.fr</a>. </li></ul>',
  },
  ST: {
  ...
  Stat: {
    ...
    innerHTML:
      '<p id="Stat" class="has-medium-font-size"> also <strong><a href="#HSt">HSt</a></strong>.</p><ul class="wp-block-list has-medium-font-size"> <li>Horner, G. (1904). <em><a href="https://archive.org/details/statutesapostle00unkngoog/page/n6/mode/2up" rel="noreferrer noopener" target="_blank">The Statutes of the Apostles or Canones Ecclesiastici. Edited with Translation and Collation from Ethiopic and Arabic MSS.; Also a Translation of the Saʿidic and Collation of the Bohairic Versions; and Saʿidic Fragments</a></em>. London: Williams &amp; Norgate.</li></ul>',
  },
  Stegemann: {
    title:
      'Kopt. Zaubertexte, ed. V. Stegemann (Sitz. d. Heidelb. Akad., 1934)',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Stegemann, V. (1934). <em><a href="https://oi-idb-static.uchicago.edu/multimedia/2387/stegemann_koptischen_zaubertexte.pdf" rel="noreferrer noopener" target="_blank">Die koptischen Zaubertexte der Sammlung Papyrus Erzherzog Rainer in Wien</a></em>. (Sitzungsberichte der Heidelberger Akademie der Wissenschaften. Philosophisch-historische Klasse, Jahrgang 1933/34, 1. Abhandlung). Heidelberg: Carl Winters Universitätsbuchhandlung.</li></ul>',
  },
  Stern: {
    title: 'L. Stern, Koptische Grammatik, acc. to §§',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Stern, L. (1880). <em><a href="https://archive.org/details/koptischegrammat00ster/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Koptische Grammatik</a></em>. Leipzig: T. O. Weigel.</li></ul>',
  },
  Synax: {
    title: 'Synaxarium Alexandrinum, ed. J. Forget (CSCO.), 1905, 1912',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Forget, I. (1905). <em><a href="https://archive.org/details/synaxariumalexan0047copt" rel="noreferrer noopener" target="_blank">Synaxarium Alexandrinum, I, 1</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 47. Scriptores Arabici, Tomus 3). Beryti: E Typographeo Catholico. Republished: 1954, Louvain: Imprimerie Orientaliste L. Durbecq.</li> <li>Forget, I. (1912). <em><a href="https://archive.org/details/synaxariumalexan0000copt/page/n363/mode/2up" rel="noreferrer noopener" target="_blank">Synaxarium Alexandrinum, II</a></em>. (Corpus Scriptorum Christianorum Orientalium, Vol. 67. Scriptores Arabici, Tomus 11). Beryti: E Typographeo Catholico. Republished: 1954, Louvain: Imprimerie Orientaliste L. Durbecq.</li></ul>',
  },
  Tatt: {
    title: 'H. Tattam, Lexicon Aegyptiaco-Latinum, 1835',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Tattam, H. (1835). <em><a href="https://archive.org/details/lexicongyptiaco01tattgoog/page/n10/mode/2up" rel="noreferrer noopener" target="_blank">Lexicon Ægyptiaco-Latinum ex Veteribus Linguæ Ægyptiacæ Monumentis, et ex Operibus La Crozii, Woidii, et aliorum Summo Studio Congestum cum Indice Vocum Latinarum</a></em>. Oxonii: E Typographeo Academico.</li></ul>',
  },
  TDi: {
    title: 'Tuki, Diurnum Alexandrinum, 1750',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Bishop Rūfāʾīl al-Ṭūḫī. (1750). <em><a href="https://digitale-sammlungen.ulb.uni-bonn.de/content/titleinfo/244155" rel="noreferrer noopener" target="_blank">ⲟⲩϫⲱⲙ ⲛ̀ⲧⲉ ⲛⲓⲉⲩⲭⲏ ⲙ̀ⲡⲓⲉ̀ϩⲟⲟⲩ ⲛⲉⲙ ⲡⲓⲉ̀ϫⲱⲣϩ ⲛ̀ⲍ︦ — كتاب الصلوات النهارية والليلية السبعة</a></em>. Romae: Typis Sacrae Congregatio de Propaganda Fide.</li></ul>',
  },
  TEuch: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Bishop Rūfāʾīl al-Ṭūḫī. (1761). <em><a href="https://digitale-sammlungen.ulb.uni-bonn.de/content/titleinfo/121458" rel="noreferrer noopener" target="_blank">ⲡⲓϫⲱⲙ ⲉϥⲉⲣⲁⲡⲁⲛⲧⲟⲕⲧⲓⲛ ⲉ̀ϫⲉⲛ ⲛⲓⲉⲩⲭⲏ ⲉⲑⲟⲩⲁⲃ ⲡⲓⲙⲉⲣⲟⲥ ⲛ̀ϩⲟⲩⲓⲧ ⲉⲑⲃⲉ ⲛⲓϫⲓⲛⲫⲱϣ ⲛ̀ⲛⲏ ⲉⲧⲁⲩⲥⲱⲧⲡ ⲛ̀ⲛⲓⲧⲱⲧⲉⲣ ⲛ̀ⲕⲗⲏⲣⲓⲕⲟⲥ ⲛⲉⲙ ⲛⲓⲟⲩⲏⲃ ⲛⲉⲙ ⲡⲓⲥⲙⲟⲩ ⲛ̀ⲧⲉ ⲛⲓϩⲃⲱⲥ ⲙ̀ⲙⲟⲛⲁⲭⲟⲥ ⲛⲉⲙ ⲡⲓⲉⲛⲓⲑⲣⲟⲛⲓⲥⲙⲟⲥ ⲛ̀ⲧⲉ ⲡⲓⲉⲡⲓⲥⲕⲟⲡⲟⲥ ⲛⲉⲙ ⲡⲓⲁⲅⲓⲁⲥⲙⲟⲥ ⲙ̀ⲙⲩⲣⲟⲛ ⲛⲉⲙ ϯⲉⲕⲕⲗⲏⲥⲓⲁ –كتاب يشتمل على الصلوات المقدسة الجزء الاول لاجل رسامات المختارين لدرجات اهل الاكليروس والكهنة وتبريك ثياب الرهبان وتقديس الميرون والكنيسة</a></em>. Romae: Typis Sacrae Congregatio de Propaganda Fide.</li></ul>',
  },
  Till: {
    title: 'W. Till, Achmîmisch-Kopt. Grammatik, 1928, acc. to §§',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Till, W. (1928). <em><a href="https://archive.org/details/achmmischkoptisc0000till/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Achmîmisch-Koptische Grammatik</a></em>. Leipzig: J. C. Hinrichs’sche Buchhandlung.</li></ul>',
  },
  'Till Bau': {
    // NOTE: Listed as '— Bau'!
    title: 'Eine Kopt. Bauernpraktik (Mitt. d. deut. Inst. Kairo, vi, 1936)',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Till, W. (1936). <a href="https://archive.org/details/egyptology-archive-vol.-6-1935/page/108/mode/2up" rel="noreferrer noopener" target="_blank">Eine koptische Bauernpraktik</a>. <em>Mitteilungen des Deutschen Archäologischen Instituts Kairo</em>, 6, pp. 108–114. </li></ul>',
  },
  'Till Oster': {
  ...
  TurO: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Turayev, B. A. (1899). <a href="https://www.biodiversitylibrary.org/item/94351#page/503/mode/1up" rel="noreferrer noopener" target="_blank">Коптскія ostraca коллекціи В. С. Голенищева</a> [Coptic ostraca from the collection of V. S. Golenishchev]. <em>Bulletin de l’ Académie Impériale des Sciences de St.-Pétersbourg</em>, 5e série, T. X, no. 5, pp. 435–449. </li></ul>',
  },
  'Turin ostr': {
  ...
  Wess: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Wessely, C. (1901–1924). <em>Studien zur Palaeographie und Papyruskunde</em>, 23 vols. Leipzig: Verlag von E. Avenarius. [Digitised volumes listed and linked on <a href="https://de.wikisource.org/wiki/Studien_zur_Palaeographie_und_Papyruskunde" rel="noreferrer noopener" target="_blank">de.WikiSource.org</a>.] </li></ul>',
  },
  WHatch: {
  ...
  Wor: {
    ...
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Worrell, W. (1923). <em><a href="https://archive.org/details/copticmanuscript00coel/page/n11/mode/2up" rel="noreferrer noopener" target="_blank">The Coptic Manuscripts in the Freer Collection</a></em>. New York: The Macmillan Company.</li></ul>',
  },
  WS: {
    title:
      'Crum & Bell, Coptic Texts from Wadi Sarga (= Coptica III), 1922, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Crum, W. E., &amp; Bell, H. I. (1922). <em><a href="https://archive.org/details/wadisargacopticg00crumuoft/page/n7/mode/2up" rel="noreferrer noopener" target="_blank">Wadi Sarga: Coptic and Greek Texts from the Excavations Undertaken by the Byzantine Research Account</a></em>. (Coptica Consilio et Impensis Instituti Rask-Oerstediani III). Copenhagen: Gyldendalske Boghandel-Nordisk Forlag.</li></ul>',
  },
  WTh: {
    title:
      'E. O. Winstedt, Coptic Texts on St. Theodore (Text & Transl. Soc.), 1910',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li>Winstedt, E. O. (1910). <em><a href="https://archive.org/details/coptictextsonsai00wins/page/n5/mode/2up" rel="noreferrer noopener" target="_blank">Coptic Texts on Saint Theodore the General, St. Theodore the Eastern, Chamoul, and Justus</a></em>. (Text and Translation Society). London: Williams and Norgate.</li></ul>',
  },
  WZKM: {
    title: 'Wiener Zeitsch. f. d. Kunde d. Morgenlandes',
    innerHTML:
      '<ul class="wp-block-list has-medium-font-size"> <li> <em>Wiener Zeitschrift für die Kunde des Morgenlandes</em> began in 1887. Early digitised volumes listed on <a href="https://onlinebooks.library.upenn.edu/webbin/serial?id=wienermorgenlandes" rel="noreferrer noopener" target="_blank">The Online Books Page</a> and others on <a href="https://catalog.hathitrust.org/Record/000077758" rel="noreferrer noopener" target="_blank">HathiTrust</a> (via US access only). </li></ul>',
  },
  Z: {
    title: 'G. Zoega, Catalogus Codd. Copticorum &c. 1810, acc. to pp',
    innerHTML:
      '<ul class="wp-block-list"> <li class="has-medium-font-size">Zoega, G. (1810). <em><a href="https://archive.org/details/bub_gb_8EAcFCioIQEC/page/n1/mode/2up" rel="noreferrer noopener" target="_blank">Catalogus codicum Copticorum manu scriptorum qui in Museo Borgiano Velitris adservantur</a></em>. Romae: Typis Sacrae Congregationis de Propaganda Fide.</li></ul>',
  },
  ZNTW: {
 ...
 * @param source
 */
function add(key: string, source: Source): void {
