...
export const DATA = [
  ...
  {
    "title": "Kitâb al-Abṣâlmudîyah al-Muḳaddasah al-Sanawîyah (Theotokia), Alexandria, 1908",
    "description": [
  ...
  {
    "title": "Epiphanius, De XII Gemmis, ed. R. P. Blake, Coptic fragts. by H. De Vis, 1934 (in Lake’s Studies &amp; Documents)",
    "description": [
  ...
  {
    "title": "Codices Coptici Vaticani &amp;c., T.I, edd. Hebbelynck &amp; Lantschoot, Rome, 1937",
    "description": [
  ...
  {
    "title": "H. De Vis, Homélies Coptes (= Coptica I, V), 1922, 1929 (DeV alone = vol. I)",
    "description": [
  ...
  {
    "title": "New Texts from the Monastery of St. Macarius, ed. H. G. Evelyn White, 1926; or his copies of MSS from Nitria (in Coptic Museum, Cairo)",
    "description": [
  ...
  {
    "title": "Forbes Robinson, Coptic Apocr. Gospels (= Texts &amp; Studies iv), 1896",
    "description": [
  ...
  {
    "title": "E. Amélineau, De Historia Lausiaca, 1887; but Hist Laus = E. C. Butler’s edition of Greek text (= Texts &amp; Studies vi)",
    "description": [
  ...
  {
    "title": "ⲡϫⲱⲙ ⲛⲧⲉ ⲡⲓⲑⲱϩⲥ ⲉⲑ︦ⲩ︦ (Kitâb al-Masḥah, ay al-Ḳandîl), ed. C. Labîb, Cairo, AM. 1625, v TRit 144 ff",
    "description": [
  ...
  {
    "title": "C. Labîb, Coptic-Arabic Dictionary (ⲡⲓⲗⲉⲝⲓⲕⲟⲛ ⲛϯⲁⲥⲡⲓ ⲛⲧⲉ ⲛⲓⲣⲉⲙⲛⲭⲏⲙⲓ Ḳâmûs al-Luġah al-Ḳibṭîyah al Maṣrîyah), Cairo, AM. 1611 ff",
    "description": [
  ...
  {
    "title": "A. van Lantschoot, Recueil de Colophons… sahidiques, 1929, acc. to numbers; also copies by",
    "description": [
  ...
  {
    "title": "Paschal Hymns: Kitâb Ṭaruḥât al-Baskhah al-Muḳaddasah, Old Cairo, 1914",
    "description": [
  ...
  {
    "title": "F. Rösch, Vorbemerkungen zu e. Gramm. d. achmîmischen Mundart, 1909, acc. to pp",
    "description": [
  ...
  {
    "title": "G. Steindorff, Koptische Grammatik², acc. to §§, or information from him",
    "description": [
  ...
  {
    "title": "Kopt. Zaubertexte, ed. V. Stegemann (Sitz. d. Heidelb. Akad., 1934)",
    "description": [
  ...
  {
    "title": "Osterbrief u. Predigt in achm. Dialekt, Vienna, 1931 (at first as Vi 10157)",
    "description": [
  ...
  {
    "title": "Gebhardt, Harnack &amp; C. Schmidt, Texte u. Untersuchungen (Bd. 43 Gespräche Jesu)",
    "description": [
  ...
  {
    "title": "W. H. Worrell, Coptic MSS. in Freer Collection (University of Michigan Studies), 1923",
    "description": [
  ...
  {
    "title": "E. O. Winstedt, Coptic Texts on St. Theodore (Text &amp; Transl. Soc.), 1910",
    "description": [
